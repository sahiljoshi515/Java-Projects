...
public class SalaryCalculatorTest {
   ...
   @Test public void calculateAnnualSalaryCorrectTest() {
      ...
      assertEquals("Test 2: calculateAnnualSalary with rate 20, hrs/week 40.", 40000.00, annSal, .01);
   }  
   ...
   @Test public void calculateMonthlySalaryCorrectTest() {
      ...
      assertEquals("Test 3: calculateMonthlySalary with rate 20, hrs/week 40.", 3333.33, monthSal, .01);
   } 
